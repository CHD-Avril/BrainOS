...
| 1.0 | 工程 | Codex | [done] | D+1 | 0.3 | R10 |
| 2.0 | 后端/前端 | Codex | [done] | D+2 | 1.0 | R1 |
| 3.0 | 后端/前端 | Codex | [done] | D+3 | 2.0 | R2、R3 |
| 4.0 | 后端/前端 | Codex | [done] | D+5 | 3.0 | R4、R5 |
| 5.0 | 后端/前端 | Codex | [done] | D+7 | 4.0 | R6、R7 |
| 6.0 | 后端/前端 | Codex | [done] | D+8 | 2.0 | R8、R9 |
| 7.0 | 测试/部署 | Codex | [done] | D+9 | 3.0、4.0、5.0、6.0 | R1-R10 |
| 8.0 | 交付 | Codex | [done] | D+10 | 7.0 | R10 |
